		                      ...
		                      <div class="col-sm-3 col-xs-6 user-match">
		                        ...
		                        <div class="user-profile">
		                          ...
		                          <ul class="user-action">
		                            <li>
		                              <a class="action-message " href="<?php echo base_url()?>message/create" data-pjax='#right-content'>
		                                <i class="fa fa-envelope"></i>
		                              </a>
		                            </li>
		                            <li class="btn-chat" data-id="<?php echo $u['id']?>" data-display-name="<?php echo $u['code_id']?>">
		                              <a class="action-message" href="javascript:void(0);">
		                                <i class="fa fa-comment"></i>
		                              </a>
		                            </li>
		                            <li>
		                              <a class="action-favorite <?php if(checkActivity(getSessionUser(), $u['id']) == 1){ echo "active";} ?> user_fav_<?php echo $u['id']?>" href="javascript:void(0);" data-id="<?php echo $u['id']?>">
